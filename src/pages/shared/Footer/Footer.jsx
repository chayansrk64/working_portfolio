...
const Footer = () => {
    return (
        <footer className="footer p-10 py-20 bg-gradient-to-r from-violet-500 to-fuchsia-500 text-white ">
  <div>
    ...
    <p>srk Industries Ltd.<br/>Providing reliable tech since 2022</p>
   <div className="flex">
   <span className='bg-[#e8e8e8] mr-3 p-2 text-2xl rounded-lg hover:bg-gradient-to-r from-cyan-500 to-blue-500'> <Link to="https://www.linkedin.com/in/chayansrk64/"><FaLinkedin /></Link> </span>
<span className='bg-[#e8e8e8] mr-3 p-2 text-2xl rounded-lg hover:bg-gradient-to-r from-cyan-500 to-blue-500'> <Link to="https://www.facebook.com/chayansrk64/"><FaFacebook /></Link> </span>
