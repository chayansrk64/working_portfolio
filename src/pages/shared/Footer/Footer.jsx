...
const Footer = () => {
    return (
     <Fade direction="top">
          <footer className="text-black border-4 border-black">
         <div className="footer p-10 py-10   ">
  <div>
   ...
   <button className="flex items-center mt-2 text-xl py-2 px-4 border-4 border-black btn_hover">
